...
# cd /mnt/dataset/vnwy44/code/HEX && ./scripts/libero/eval_libero_job.sh
...
sleep 15   # Wait for the inference server to finish initialization.

# ==== Start LIBERO evaluation ====
source /opt/conda/etc/profile.d/conda.sh
conda activate hlmvla
...
# ==== Stop the inference server after evaluation ====
