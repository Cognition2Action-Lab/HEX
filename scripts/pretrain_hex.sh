...
# cd /mnt/dataset/vnwy44/code/HEX && ./scripts/pretrain_hex.sh
...
dataset_name=EAI_real_world   # or EAI_real_world_wo_tienkung
data_root_dir=/mnt/dataset/vnwy44/data/eai_real_world

vision_history_length=2
enable_mee=false
run_id=hex_ac100_300k_8gpu_state_query_history${vision_history_length}
